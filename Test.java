...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < binary.length; ++i) {
            testInst = binary[i];
            isBreak = printDis(testInst, isBreak);
            PC += 4;
        }
        foutDis.close();
    ...
    public static boolean printDis(String testInst, boolean isBreak) {
        long twosLong;
        String formatTest;
        String opCode;
    ...
    public static String getInstString(String test) {
        ...
        instString = switch (opName) {
            case "ADD", "AND", "MOVZ", "MUL", "OR", "SUB" -> "R" + 
            ...
            case "SLL", "SRL" -> "R" + ((Integer)(Integer.parseInt(test.substring(16, 21), 2))).toString() + ", " + 
                    "R" + ((Integer)(Integer.parseInt(test.substring(11, 16), 2))).toString() + ", " + "#" + 
